...
class Plugin:
    ...
    async def check_table_scans(self, sha256: str, app_id: int | None = None, target_process: str | None = None):
        return await self.operations.run_blocking(self._svc().check_table_scans, sha256, app_id, target_process)
    ...
    async def launch_ce_for_game(self, app_id: int, proton_tool_id: str | None = None, automatic: bool | None = None):
        return await self.operations.create(
